...
const breathing = 1 + Math.sin(t * 0.6 + phase) * 0.035;
const swirl = Math.sin(t * 0.48 + phase * 1.1) * 0.12;
        ...
        const now = time;
        const diagramInterval = pointerActive ? 60 : 120;
        const meshInterval = pointerActive ? 120 : 220;
